...
function setStatistics()
	...
	gpu.set(paddingLeft + 16, paddingTop, tostring(cellCount))
	gpu.set(paddingLeft + 16, paddingTop + 1, tostring(TSLU))
	gpu.set(paddingLeft + 16, paddingTop + 3, tostring(0))
	gpu.set(paddingLeft + 16, paddingTop + 5, tostring(lowestRF))
	gpu.set(paddingLeft + 16, paddingTop + 6, tostring(lowestRFTime))
	gpu.set(paddingLeft + 16, paddingTop + 8, tostring(highestRF))
	gpu.set(paddingLeft + 16, paddingTop + 9, tostring(highestRFTime))
